...
"""
Example code to add demographic data into the UPM database - simulates IFE
"""
...
info['age'] = 40
info['country_birth'] = "Brasile"
info['languages'] = ["Inglese", "Polacco", "Russo", "Portoghese"]
info['proficiency'] = "C2"
info['educational_level'] = "postlaurea"
