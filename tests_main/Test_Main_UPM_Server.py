...
token = '982af6ae-09b5-4125-9b30-9335e25d29ec'

### Test 1
print "*** Test 1: IFE send demographic data to UPM"

url = 'http://localhost:8080/?request_type=send_demo_data&age=20&country_birth=Brazil&languages=Italian&proficiency=C1&educational_level=primary&disability=%20&familiarity_PA=basic&occupation=None&token='+token
...
url = 'http://localhost:8080/?request_type=request_demo_data&token='+token
...
url = 'http://localhost:8080/?request_type=request_inter_data&token='+token+'&inter_type=syntactic'
...
url = 'http://localhost:8080/?request_type=request_inter_data&token='+token+'&inter_type=elaboration'
...
url = 'http://localhost:8080/?request_type=request_inter_data&token='+token+'&inter_type=lexical'
...
url = 'http://localhost:8080/?request_type=request_inter_data&token='+token+'&inter_type=workflow'
...
url = 'http://localhost:8080/?request_type=request_data&inter_type=lexical&token='+token
...
url = 'http://localhost:8080/?request_type=request_data&inter_type=syntactic&token='+token
...
url = 'http://localhost:8080/?request_type=request_data&inter_type=elaboration&token='+token
...
url = 'http://localhost:8080/?request_type=request_data&inter_type=workflow&token='+token
...
url = 'http://localhost:8080/?request_type=request_data&inter_type=%20&token='+token
